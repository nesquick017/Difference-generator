...
const resJSON = [
    {
        ...
        children: [
            ...
            { key: 'setting3', type: 'changed', newValue: true, oldValue: null },
            ...
            { key: 'setting5', type: 'added', value: { key5: 'value5' } },
            {
                ...
                type: 'nested',
                children: [
                    { key: 'doge', type: 'nested', children: [{ key: 'wow', type: 'changed', newValue: '', oldValue: 'so much' }] },
    ...
    },
    {
        ...
        type: 'nested',
        children: [
            { key: 'baz', type: 'changed', newValue: 'bas', oldValue: 'bars' },
            { key: 'foo', type: 'unchanged', value: 'bar' },
            { key: 'nest', type: 'changed', newValue: { key: 'value' }, oldValue: 'str' },
        ],
    },
...
export { resJSON, resStylish, resPlain };
